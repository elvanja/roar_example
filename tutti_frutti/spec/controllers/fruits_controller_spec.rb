...
describe FruitsController do
  it "should return json for a single fruit" do
    ...
    response.body.should == {id: 1, name: 'Apple', taste: 'sweet', _links: {self: {href: 'http://localhost:9292/fruits/1'}}}.to_json
  end
  ...
  it "should return json for fruits collection" do
    ...
    response.body.should == {fruits: [
      {id: 1, name: 'Apple', taste: 'sweet', _links: {self: {href: 'http://localhost:9292/fruits/1'}}},
      {id: 2, name: 'Banana', taste: 'sweet', _links: {self: {href: 'http://localhost:9292/fruits/2'}}}
    ]}.to_json
  end
end
